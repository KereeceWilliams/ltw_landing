...
urlpatterns = patterns('',
                       ...
                       url(r'^register/create/$', login_required(RegisterCreateWizardView.as_view()), name='register_create'),  
                       ...
                       url(r'^contact_us/create/$', Contact_Us.as_view(), name='contact_us'),
                       url(r'^about_us/$', About_Us.as_view(), name='about_us'),
                       url(r'^register/waiver/$', RegisterWaiverCreateView.as_view(), name='register_waiver'),
                       url(r'^thank_you/$', Thank_You.as_view(), name='thank_you'),
